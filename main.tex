...
\begin{longtable}{>{\Large}p{1.4\ltw}>{\Large}p{1.4\ltw}>{\footnotesize}p{1.85\ltw}>{\footnotesize}p{2.8\ltw}>{\footnotesize}p{2\ltw}}
   \footnotesize Vekil \newline harf
  & \footnotesize Eski yazı \newline harf
  & \footnotesize Eski yazı \newline harf ismi
  & \footnotesize Yeni yazı\newline karşılığı
  & \footnotesize Türkçe \newline telaffuz \\
  %
